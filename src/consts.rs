// Mintlayer HRP
pub const HRP_MINT_MAINNET: &str = "ml";
pub const HRP_MINT_TESTNET: &str = "tm";
...
pub const BECH32_P2WPKH_TESTNET: &'static str = "bt1q2wzdwh9znl8jz306ncgagapmaevkqt68am7ez0";
pub const BECH32_P2WPKH_MINT: &'static str = "ml1q2wzdwh9znl8jz306ncgagapmaevkqt68crfvtt";
pub const BECH32_P2WPKH_MINTTESTNET: &'static str = "tm1q2wzdwh9znl8jz306ncgagapmaevkqt682258s9";
